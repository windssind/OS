#ifndef __ARP_FRAME_H__
#define __ARP_FRAME_H__
/**
...
struct ethr_hdr {
	...
	uint32_t sip;
	uint8_t arp_dmac[6];
	uint32_t dip; //This should be 4 bytes. But alignment issues are creating a padding b/w arp_dmac and dip if dip is kept 4 bytes.
